...
- Keep each lane focused on its own series. Do not overlay the companion show's points, trends, or season boundaries; coordination comes from the shared viewport, overview, rating domain, and direct show labels.
