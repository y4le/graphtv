...
- a show-comparison route with one duplex canvas containing two coordinated lanes, one shared overview and viewport, and a common rating source when coverage permits
